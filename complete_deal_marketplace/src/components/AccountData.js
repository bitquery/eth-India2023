...
const columns1 = [
  { field: 'date', headerName: 'Date', flex: 1, headerClassName: 'bold-header' },
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const raw = JSON.stringify({
        query: "query ($network: FilecoinNetwork!, $dateFormat: String!, $sender: String) {\n  filecoin(network: $network) {\n    messages(\n      any: {receiver: {is: \"f05\"}, sender: {is: $sender}}\n      options: {limit: 10}\n      method: {is: 4}\n      date: {is: \"2023-10-10\"}\n    ) {\n      date: date {\n        date(format: $dateFormat)\n      }\n      block {\n        height\n      }\n      sender {\n        account\n        address\n        type\n      }\n      receiver {\n        account\n        address\n        type\n      }\n      method {\n        id\n        name\n      }\n      burned\n      amount\n      signedHash\n      signatureType\n      signature\n      refund\n      returnValue\n    }\n  }\n}\n",
